...
- [x] 4.1 PR openen met titel `docs: apply handbook docs contract`; body vinkt
      ...
      — PR #6, gemerged. `docs/index.md`, `docs/mcp.md`, `docs/reconcile.md` en
      `docs/reference/` staan op main, `.mcp.json` in de root (de placeholder is
      in PR #7 vervangen door de echte handbook-server). Alleen het archiveren
      was blijven liggen.